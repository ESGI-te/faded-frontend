...
const DeleteServiceCategoryModal = ({ onDelete, isLoading }) => {
    return (
                ...
                <Stack gap="2rem">
                    <ModalHeader>
                        ...
                        <Text variant="headingM" fontWeight="--fw-bold">
                            Souhaitez-vous supprimer cette category ?
                        </Text>
                    </ModalHeader>
                    <Text color="--neutral500" textAlign="center">
                        Celle-ci sera définivement supprimé.
                    </Text>
                    <Stack gap="0.5rem">
...
DeleteServiceCategoryModal.propTypes = {
    onDelete: PropTypes.func,
    isLoading: PropTypes.bool,
};

DeleteServiceCategoryModal.defaultProps = {
    isLoading: false,
    onDelete: () => {},
};
