...
const EstablishmentOverviewPage = () => {
    ...
    const globalIndicators = useGlobalIndicatorsQuery(establishmentId);
    const dailyIndicators = useDailyIndicatorsQuery(establishmentId);
    const topServices = useTopServicesQuery({ establishmentId });
...
EstablishmentOverviewPage.propTypes = {};
