import useEstablishmentAppointmentsQuery from '@queries/appointment/useEstablishmentAppointmentsQuery.hook';
...
const useTimeSlots = (date, planning, barberId) => {
    ...
    const { data: appointments, isLoading } = useEstablishmentAppointmentsQuery(establishmentId);
